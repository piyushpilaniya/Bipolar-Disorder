...
#model.add(Embedding(top_words, embedding_vecor_length, input_length=max_review_length))
    model.add(LSTM(32, input_shape=(100, 9),return_sequences=False))
...
##labels
labels_base_path="/home/amanjot/aman/segments_dataset/1500/HeadPose/"
#feats=sio.loadmat('/home/amanjot/aman/segments_dataset/');
train_labels = sio.loadmat(labels_base_path + 'Labels_Train.mat')
test_labels = sio.loadmat(labels_base_path + 'validation_lpq_labels.mat')
...
###LBPTOP
base_path="/home/amanjot/aman/segments_dataset/1500/LBPTOP/"
train_features=sio.loadmat(base_path+'Train_LBPTOP_1500.mat')
test_features=sio.loadmat(base_path+'Validation_LBPTOP_1500.mat')
