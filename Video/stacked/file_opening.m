list2=dir('/home/intern/internship_avec/prinshu/LLDs_video_openFace/');
list = [];
c = 0;
...
if length(x) > 0
        c = c+1;
s1 = '/home/intern/internship_avec/prinshu/LLDs_video_openFace/';
s2 = list2(j).name;
s=strcat(s1,s2);
M = importdata(s);
[row,col] = size(M.data);
...
y1 = 'feature';
d1 = '/home/intern/internship_avec/prinshu/output/';
y1 = strcat(d1,y1);
p = int2str(c);
p = strcat(p,'.mat');
y = strcat(y1,p);
